...
**菜名创意要求**：
- 使用抽象概念词汇：如"虚无""永恒""液态""晶体""量子""维度"
- 融入时间/空间元素：如"午夜三刻""平行宇宙""时差综合症"
- 情绪化表达：如"忧郁蓝调""狂欢后遗症""社恐治愈系"
- 哲学/艺术概念：如"存在主义沙拉""印象派汤品""解构主义"
- 科技/现代词汇：如"算法优化""云端漂浮""数字排毒"
- 每道菜名必须风格迥异，避免任何重复的语言模式
...
- **菜名多样化要求**：
  * 避免重复使用"XX的XX"格式
  * 采用多种命名风格：单一概念词（如"迷雾"）、诗意组合（如"月光与盐"）、情绪表达（如"忧郁星期二"）、时空概念（如"三点钟的永恒"）、抽象隐喻（如"液体建筑学"）
  * 每道菜名都要有独特的语言结构和表达方式
  * 优先使用令人困惑但听起来高级的抽象词汇组合
- 禁用 "XX-XX-XX" 码状标记
`;
